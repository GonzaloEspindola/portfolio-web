...
export const experienceData: ExperienceData[] = [
  {
    ...
    projects: [
      ...
      },
      {
        title: 'UFRO',
        description:
          'Experiencia destacada desarrollando diversos sitemas necesarios para la reestructuracion de una importante universidad. Abarcando todas las funcionalidades necesarias para una correcta adminitracion interna.',
        techs: [
          {
            name: 'Nuxt',
            link: 'https://nuxt.com/',
